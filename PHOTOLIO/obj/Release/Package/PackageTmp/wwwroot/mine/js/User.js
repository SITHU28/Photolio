...
function saveuser() {
    ...
    var Photoshop = $("#Photoshop").val();
    var Photography = $("#Photography").val();
    var Illustrator = $("#Illustrator").val();
    var Media = $("#Media").val();
    var PremierePro = $("#PremierePro").val();
    var Lightroom = $("#Lightroom").val();
    var Burmese = $("#Burmese").val();
    var English = $("#English").val();
    var Chinese = $("#Chinese").val();
    var PackageTitle = $("#PackageTitle").val();
    var AboutPackage = $("#AboutPackage").val();
    ...
    data.append("Photoshop", Photoshop);
    data.append("Photography", Photography);
    data.append("Illustrator", Illustrator);
    data.append("Media", Media);
    data.append("PremierePro", PremierePro);
    data.append("Lightroom", Lightroom);
    data.append("Burmese", Burmese);
    data.append("English", English);
    data.append("Chinese", Chinese);
    data.append("PackageTitle", PackageTitle);
    data.append("AboutPackage", AboutPackage);
...
function getInputData() {
    return JSON.stringify({
        ...
        "Media": $("#Media").val(),
        "PremierePro": $("#PremierePro").val(),
        "Lightroom": $("#Lightroom").val(),
        "Burmese": $("#Burmese").val(),
        "English": $("#English").val(),
        "Chinese": $("#Chinese").val(),
        "PackageTitle": $("#PackageTitle").val(),
        "AboutPackage": $("#AboutPackage").val(),
